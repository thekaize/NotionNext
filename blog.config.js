...
const BLOG = {
  API_BASE_URL: process.env.API_BASE_URL || 'https://www.thefox.work', // API默认请求地址,可以配置成自己的地址例如：https://[xxxxx].notion.site/api/v3
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Pious fox', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '“以颤抖之身追赶，怀敬畏之心挑战”', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'www.thefox.work', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '博客,Pious fox,经济学，日常思考', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://img.cdn1.vip/i/6a706e7b1c103_1785753211.webp', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
